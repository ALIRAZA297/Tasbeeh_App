...
class _QiblaScreenState extends State<QiblaScreen>
    ...
    return StreamBuilder<QiblahDirection>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          ...
          return _buildErrorWidget('Error getting compass direction: $errorMsg');
        }
  ...
  Widget _buildCompassWidget(QiblahDirection qiblahDirection, double screenWidth) {
    return Container(
      width: double.infinity,
  ...
  Widget _buildInfoCard(
    ...
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Get.isDarkMode ? color.withOpacity(0.15) : color.withOpacity(0.1),
        borderRadius: BorderRadius.circular(16),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color:
                (Get.isDarkMode ? black : const Color(0xFFFDE68A)).withOpacity(0.2),
            blurRadius: 10,
            offset: const Offset(0, 5),
          ),
        ],
      ...
      child: Column(
        children: [
          CircleAvatar(
            backgroundColor:
                Get.isDarkMode ? const Color(0xFF10B981) : const Color(0xFFF59E0B),
  ...
  Widget _buildPermissionButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed:
            !_isLocationServiceEnabled ? _openLocationSettings : _requestLocationPermission,
        style: ElevatedButton.styleFrom(
          backgroundColor: primary700,
          padding: const EdgeInsets.symmetric(vertical: 16),
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(!_isLocationServiceEnabled ? Icons.location_on : Icons.location_searching,
                color: white),
            const SizedBox(width: 12),
            Text(
              !_isLocationServiceEnabled
